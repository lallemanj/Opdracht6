...
namespace AandelenBeheerOpdracht6
{
    public partial class FormAandelen : Form
    {
        ...
        {
            this.Validate();
            //this.aandelenBindingSource.AddNew();
        ...
        private void transactiesBindingSource_CurrentChanged(object sender, EventArgs e)
        {

        }

        private void aandelenBindingNavigator_RefreshItems(object sender, EventArgs e)
        {

        }

        private void aandelenBindingSource_CurrentChanged(object sender, EventArgs e)
        {
